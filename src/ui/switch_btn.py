...
class SwitchBtn(QWidget):
    ...
    def drawText(self, event, painter):
        ...
        if self.checked:
            ...
            painter.drawText(self.space, 0, self.width() / 2 + self.space * 2, self.height(), Qt.AlignCenter,
                             self.textOn)
        else:
            painter.setPen(self.textColorOff)
            painter.drawText(self.width() / 2 - self.space * 2, 0, self.width() / 2 - self.space, self.height(),
